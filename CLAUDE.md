...
- **Push: NUNCA automático.** Sempre apresente primeiro: resumo, branch, commits, testes, arquivos relevantes e o PR proposto; aguarde autorização explícita ("Sim, pode fazer push") antes de executar. Push direto em `development`/`master` não faz parte do workflow do agente.
