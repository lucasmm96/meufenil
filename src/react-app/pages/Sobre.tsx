    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4 text-left md:text-justify">
            <p>
              ...
              essa condição era completamente desconhecida para mim. A convivência
              me mostrou o quanto ainda faltam recursos no Brasil para pacientes
              com PKU — como fórmulas mais palatáveis, acesso ao Dicloridrato de
              Sapropterina (
              <a
            ...
            <p>
              Manter uma dieta tão restritiva, com pouca informação disponível, é
              um grande desafio. Por isso, decidi unir meu conhecimento em
            ...
            <p>
              ...
              ingestão de alimentos e da fenilalanina. Os dados iniciais têm como
              base tabelas públicas disponibilizadas pela{" "}
              <a
              ...
              , e o usuário também pode cadastrar seus próprios alimentos caso não
              os encontre na lista.
            </p>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
          ...
          {/* passos mantidos exatamente como você escreveu */}
          {/* (não alterei conteúdo, só auth) */}
        </div>
