...
- [BR-005](Specs-Current-Domain-Business-Rules), [BR-014](Specs-Current-Domain-Business-Rules), [BR-015](Specs-Current-Domain-Business-Rules)

## Frontend

- [pages/historico](Specs-Current-Frontend-Pages-Historico)
...
- [registros](Specs-Current-Database-Registros)

## Security

- [security-model](Specs-Current-Security-Security-Model) (SELECT/DELETE dono/delegado)
...
- [FEAT-0005 Dashboard](Specs-Current-Features-FEAT-0005-Dashboard), [FEAT-0007 Estatísticas](Specs-Current-Features-FEAT-0007-Estatisticas)
