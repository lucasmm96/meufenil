...
- E3 — Variáveis usadas: inventário em [../security/secrets-and-environments.md](Specs-Current-Security-Secrets-And-Environments) `[CONFIRMED: code]`
- E4 — Ausência de testes da CLI `[CONFIRMED: ausência]`

## Veja também

- [overview.md](Specs-Current-Backend-Overview), [../database/overview.md](Specs-Current-Database-Overview) (migrations), [../security/secrets-and-environments.md](Specs-Current-Security-Secrets-And-Environments)
