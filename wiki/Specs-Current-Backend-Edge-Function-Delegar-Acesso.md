...
- [../database/delegacoes_acesso.md](Specs-Current-Database-Delegacoes_acesso), [../security/security-model.md](Specs-Current-Security-Security-Model)
- [edge-function-delete-account.md](Specs-Current-Backend-Edge-Function-Delete-Account), [overview.md](Specs-Current-Backend-Overview)
