...
**Governança:** [`CONVENTIONS.md`](Specs-CONVENTIONS) — leia antes de criar ou alterar qualquer arquivo deste diretório.
...
- Governança: [`CONVENTIONS.md`](Specs-CONVENTIONS)
- Mapa funcional (ponto de partida): [`current/system-map.md`](Specs-Current-System-Map)
- Mapa arquitetural: [`current/architecture/overview.md`](Specs-Current-Architecture-Overview)
- Templates: [`templates/`](Specs-Templates)
- Catálogo de propostas: [`proposed/index.md`](Specs-Proposed-Index)
- Arquivo de propostas concluídas: [`archive/`](Specs-Archive)
