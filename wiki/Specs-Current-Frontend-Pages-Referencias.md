...
- Enforcement real: banco (ver [security-model](Specs-Current-Security-Security-Model)) `[CONFIRMED: security-model]`.
...
Conforme [overview.md](Specs-Current-Frontend-Overview) (tabela × cards mobile; modal bottom-sheet × central) `[CONFIRMED: code]`.
...
- [modal-referencia.md](Specs-Current-Frontend-Components-Modal-Referencia), [../database/referencias.md](Specs-Current-Database-Referencias), [../database/rpc.md](Specs-Current-Database-Rpc)
- [admin.md](Specs-Current-Frontend-Pages-Admin) (visão admin do mesmo domínio)
