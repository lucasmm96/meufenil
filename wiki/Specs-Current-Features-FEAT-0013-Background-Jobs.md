...
- [BR-027](Specs-Current-Domain-Business-Rules)
...
- [api-keepalive](Specs-Current-Backend-Api-Keepalive), [background-jobs](Specs-Current-Backend-Background-Jobs)
- [api-referencias-sync](Specs-Current-Backend-Api-Referencias-Sync) (FEAT-0017 — segunda função Vercel cron, semanal; persiste em `referencia_syncs`, fora da BR-027)

## Database

- [background_job_executions](Specs-Current-Database-Background_job_executions), [triggers](Specs-Current-Database-Triggers)

## Security

- [security-model](Specs-Current-Security-Security-Model) (leitura admin-only; escrita service role; sem policies de INSERT)
...
- [FEAT-0012 Admin](Specs-Current-Features-FEAT-0012-Painel-Administrativo) (monitoramento)
- [FEAT-0017 Sincronização de referências](Specs-Current-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa) (cron semanal próprio; job com retenção própria, fora do trim 365d da BR-027)
