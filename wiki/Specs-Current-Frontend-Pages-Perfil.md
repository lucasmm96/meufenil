...
- **Delegações:** via AuthContext → edge function (ver [edge-function-delegar-acesso](Specs-Current-Backend-Edge-Function-Delegar-Acesso)); `carregarDelegacoes()` no mount `[CONFIRMED: code]`.
...
- [login-as](Specs-Current-Frontend-Components-Login-As) (cards de delegação), [edge-function-delete-account](Specs-Current-Backend-Edge-Function-Delete-Account), [usuarios](Specs-Current-Database-Usuarios)
