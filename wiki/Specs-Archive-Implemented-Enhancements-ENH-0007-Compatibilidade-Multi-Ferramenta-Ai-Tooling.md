...
→ Tooling atual em [`CLAUDE.md`](Specs-Archive-CLAUDE), [`.claude/`](Specs-Archive-.claude) e [`.ai/specs/`](Specs-Archive-Implemented).
...
- Draft original: `.ai/specs/proposed/draft/archive/006-generic-ai-tooling.md`
- ENH-0005 (IMPLEMENTED): [`.ai/specs/archive/implemented/enhancements/ENH-0005-revisao-tooling-ia.md`](Specs-Archive-Archive-Implemented-Enhancements-ENH-0005-Revisao-Tooling-Ia)
- Tooling atual: [`CLAUDE.md`](Specs-Archive-CLAUDE), [`.claude/agents/`](Specs-Archive-.claude-Agents), [`.ai/specs/`](Specs-Archive-Implemented)
- AGENTS.md standard: [agents.md](https://agents.md/) (Agentic AI Foundation / Linux Foundation)
...
- Convenções: [`.ai/specs/CONVENTIONS.md`](Specs-Archive-Implemented-CONVENTIONS)
