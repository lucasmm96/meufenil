...
1. Overlay modal padrão ([overview.md](Specs-Current-Frontend-Overview)) — `fixed inset-0 bg-black/50 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4`; painel `max-w-md max-h-[92vh] overflow-y-auto` (bottom-sheet mobile × central desktop) `[CONFIRMED: code — ModalMensagemExecucao.tsx:15-16]`.
...
- [modal-referencia.md](Specs-Current-Frontend-Components-Modal-Referencia), [../pages/admin.md](Specs-Current-Frontend-Pages-Admin), [../overview.md](Specs-Current-Frontend-Overview)
