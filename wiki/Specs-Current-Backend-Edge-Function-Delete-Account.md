...
- E3 — FKs e cascades: catálogo (Fase 2) + [../database/usuarios.md](Specs-Current-Database-Usuarios), [../database/registros.md](Specs-Current-Database-Registros) `[CONFIRMED: database]`
- E4 — `.npmrc` e `deno.json` presentes no diretório da função `[CONFIRMED: filesystem]`

## Veja também

- [edge-function-delegar-acesso.md](Specs-Current-Backend-Edge-Function-Delegar-Acesso), [overview.md](Specs-Current-Backend-Overview)
- [../database/usuarios.md](Specs-Current-Database-Usuarios), [../security/security-model.md](Specs-Current-Security-Security-Model)
