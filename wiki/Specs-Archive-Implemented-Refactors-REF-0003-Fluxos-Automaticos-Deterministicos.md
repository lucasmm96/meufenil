...
- [ADR-0012](Specs-Archive-Decisions-ADR-0012-Spec-Driven-Github-Operations) — nota de revisão nos itens 8 e 12 (texto original preservado).
- ADR-0013 novo — fluxos automáticos determinísticos sem IA (Origin CONTEMPORARY).
- [CONVENTIONS.md §18.7](Specs-Archive-CONVENTIONS) — triagem manual + resposta estática.
...
[ADR-0012](Specs-Archive-Decisions-ADR-0012-Spec-Driven-Github-Operations); [CONVENTIONS.md §18.7/§18.9](Specs-Archive-CONVENTIONS); `.github/workflows/issue-triage*.yml`; `.github/prompts/issue-triage.md`; `scripts/spec-github/` (padrões determinísticos reutilizáveis: `lib/specs.js`, `lib/release-traceability.js`, `release-verify.js`).
