...
As 33 BRs existentes (Fases 7) seguem este formato; novos campos (Applies To) são cobertos por **Related Features**. A matriz BR × Implementation × Spec × Test consolidada vive em [`current/domain/traceability.md`](Specs-Current-Domain-Traceability) — não duplicar nas BRs.
