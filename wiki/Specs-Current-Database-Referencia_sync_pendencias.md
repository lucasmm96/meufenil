...
- RPC `aplicar_sync_referencias` (criação) — [rpc.md](Specs-Current-Database-Rpc)
- RPC `decidir_pendencia_referencia` (decisão) — [rpc.md](Specs-Current-Database-Rpc)
- RPCs `reverter_sync_referencias` / `restaurar_referencias_de_backup` (cancelamento) — [rpc.md](Specs-Current-Database-Rpc)
...
- [referencia_syncs.md](Specs-Current-Database-Referencia_syncs), [referencia_eventos.md](Specs-Current-Database-Referencia_eventos)
