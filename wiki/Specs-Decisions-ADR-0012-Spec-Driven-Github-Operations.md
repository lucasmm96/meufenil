...
> **Nota de revisão (2026-08-24):** os itens 8 (Issues externas) e 12 (Automação) foram revisados pela [ADR-0013](Specs-Decisions-ADR-0013-Fluxos-Automaticos-Deterministicos-Sem-Ia) — IA apenas no modo interativo; resposta estática de Issues externas (W3 `issue-responder`) e gate de produção (W7 `release-gate`). Texto original preservado.
