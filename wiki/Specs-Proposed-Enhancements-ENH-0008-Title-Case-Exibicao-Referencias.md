...
- `lib/referencias.ts` — `nomeComMarca` monta a apresentação combinada `nome (Marca: X)` sem normalização de caixa ([FEAT-0008](Specs-Current-Features-FEAT-0008-Referencias-Alimentares))
...
- Banco de dados armazena verbatim por design (`src/shared/referencias-sync/canonical.ts`: "O VALOR persistido nunca é normalizado aqui (verbatim, fidelidade §3/§6)") — comportamento correto e intencional ([FEAT-0017](Specs-Current-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa))
...
- [FEAT-0008 Referências alimentares](Specs-Current-Features-FEAT-0008-Referencias-Alimentares) — display de nome/marca em todos os fluxos da página
- [FEAT-0003 Registro diário](Specs-Current-Features-FEAT-0003-Registro-Diario-Consumo) — `nome_alimento` exibido em `Historico.tsx` (via `nomeComMarca` em `registros.service.ts`)
- [FEAT-0005 Dashboard](Specs-Current-Features-FEAT-0005-Dashboard) — exibição de referência selecionada (via `registros.service.ts`)
- [FEAT-0012 Painel administrativo](Specs-Current-Features-FEAT-0012-Painel-Administrativo) — `Admin.tsx` usa `nomeComMarcaSync`
- [FEAT-0017 Sincronização de referências](Specs-Current-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa) — display de pendências/curadoria/eventos no admin
...
- [FEAT-0008 Referências alimentares](Specs-Current-Features-FEAT-0008-Referencias-Alimentares)
- [FEAT-0017 Sincronização de referências](Specs-Current-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa)
