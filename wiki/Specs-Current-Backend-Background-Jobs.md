...
| `public.background_job_executions` | banco | persistência (ver [../database/background_job_executions.md](Specs-Current-Database-Background_job_executions)) |
| `api/keepalive.ts` | Vercel | único produtor atual ([api-keepalive.md](Specs-Current-Backend-Api-Keepalive)) |
...
- Observabilidade efetiva: linhas persistidas (job_key, run_id, status, tempos, message, details jsonb) + logs `console` do produtor (ver [api-keepalive.md](Specs-Current-Backend-Api-Keepalive)) `[CONFIRMED: code, database]`.
...
- [api-keepalive.md](Specs-Current-Backend-Api-Keepalive), [overview.md](Specs-Current-Backend-Overview)
- [../database/background_job_executions.md](Specs-Current-Database-Background_job_executions)
