...
4. **Gráfico "Últimos 7 dias"**: Recharts `LineChart` (monotone, gradiente indigo→purple, dots `#6366f1`), padrão de tooltip/eixos do [overview.md](Specs-Current-Frontend-Overview) `[CONFIRMED: code — Dashboard.tsx:179-218]`.
...
- [adicionar-registro.md](Specs-Current-Frontend-Components-Adicionar-Registro), [modal-referencia.md](Specs-Current-Frontend-Components-Modal-Referencia), [consentimento-lgpd.md](Specs-Current-Frontend-Components-Consentimento-Lgpd)
- [../database/registros.md](Specs-Current-Database-Registros), [../database/usuarios.md](Specs-Current-Database-Usuarios)
