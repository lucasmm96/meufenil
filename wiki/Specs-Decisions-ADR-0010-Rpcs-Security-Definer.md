...
- [../current/database/rpc.md](Specs-Current-Database-Rpc), [../current/security/security-model.md](Specs-Current-Security-Security-Model) (seção 10), [../current/features/FEAT-0008-referencias-alimentares.md](Specs-Current-Features-FEAT-0008-Referencias-Alimentares)
- [ADR-0004](Specs-Decisions-ADR-0004-Rls-Como-Enforcement)
