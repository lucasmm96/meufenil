...
- Trigger `trg_trim_referencia_backups` (AFTER INSERT) — função `fn_trim_referencia_backups` — [triggers.md](Specs-Current-Database-Triggers)
- RPC `restaurar_referencias_de_backup` — [rpc.md](Specs-Current-Database-Rpc)
...
- [referencia_syncs.md](Specs-Current-Database-Referencia_syncs), [referencia_snapshots.md](Specs-Current-Database-Referencia_snapshots)
- [triggers.md](Specs-Current-Database-Triggers), [rpc.md](Specs-Current-Database-Rpc), [../security/security-model.md](Specs-Current-Security-Security-Model) (§11)
