...
1. Overlay modal padrão ([overview.md](Specs-Current-Frontend-Overview)); painel `max-w-md max-h-[92vh] overflow-y-auto`; título dinâmico "Editar Referência" × "Nova Referência" + botão X (`X` icon) `[CONFIRMED: code]`.
...
- [adicionar-registro.md](Specs-Current-Frontend-Components-Adicionar-Registro), [../pages/referencias.md](Specs-Current-Frontend-Pages-Referencias), [../database/referencias.md](Specs-Current-Database-Referencias)
