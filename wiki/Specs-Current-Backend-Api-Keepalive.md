...
- RLS de `background_job_executions` não possui policies de INSERT — apenas o canal service role grava (ver [../database/background_job_executions.md](Specs-Current-Database-Background_job_executions)) `[CONFIRMED: database]`.
...
- Persistência estruturada em `background_job_executions` (ver [background-jobs.md](Specs-Current-Backend-Background-Jobs)).
...
- [background-jobs.md](Specs-Current-Backend-Background-Jobs), [overview.md](Specs-Current-Backend-Overview)
- [../database/background_job_executions.md](Specs-Current-Database-Background_job_executions), [../database/triggers.md](Specs-Current-Database-Triggers)
- [../security/secrets-and-environments.md](Specs-Current-Security-Secrets-And-Environments)
- [ADR-0007](Specs-Decisions-ADR-0007-Keepalive-Cron-Jobs)
