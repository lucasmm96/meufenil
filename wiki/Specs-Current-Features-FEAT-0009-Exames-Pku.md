...
- [BR-007](Specs-Current-Domain-Business-Rules), [BR-008](Specs-Current-Domain-Business-Rules), [BR-012](Specs-Current-Domain-Business-Rules), [BR-014](Specs-Current-Domain-Business-Rules), [BR-015](Specs-Current-Domain-Business-Rules)

## Frontend

- [pages/exames](Specs-Current-Frontend-Pages-Exames)
...
- [exames_pku](Specs-Current-Database-Exames_pku)

## Security

- [security-model](Specs-Current-Security-Security-Model) (policies dono/delegado)
...
- [FEAT-0004 Limite diário](Specs-Current-Features-FEAT-0004-Limite-Diario) (ambos medem controle de PKU)
