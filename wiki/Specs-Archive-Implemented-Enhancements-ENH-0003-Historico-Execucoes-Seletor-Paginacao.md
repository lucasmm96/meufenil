...
- [FEAT-0012 Painel administrativo](Specs-Archive-Implemented-Current-Features-FEAT-0012-Painel-Administrativo)
- [background-jobs](Specs-Archive-Implemented-Current-Backend-Background-Jobs), [background_job_executions](Specs-Archive-Implemented-Current-Database-Background_job_executions)
- [admin.md](Specs-Archive-Implemented-Current-Frontend-Pages-Admin), [modal-mensagem-execucao.md](Specs-Archive-Implemented-Current-Frontend-Components-Modal-Mensagem-Execucao)
