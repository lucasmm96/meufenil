...
Usuário · Referência · Registro de consumo · Exame PKU · Delegação de acesso · Favorito · Execução de background job — detalhe em [../domain/domain-model.md](Specs-Current-Domain-Domain-Model).
...
Detalhe em [../domain/business-rules.md](Specs-Current-Domain-Business-Rules) e no relatório da fase (`.ai/.temp/analyses/23-documentacao-product-domain.md`).

## Áreas da aplicação

9 páginas (`/`, `/dashboard`, `/referencias`, `/historico`, `/estatisticas`, `/perfil`, `/exames`, `/sobre`, `/admin`) — ver [../frontend/overview.md](Specs-Current-Frontend-Overview).
...
- [glossary.md](Specs-Current-Product-Glossary), [../domain/domain-model.md](Specs-Current-Domain-Domain-Model), [../domain/business-rules.md](Specs-Current-Domain-Business-Rules)
