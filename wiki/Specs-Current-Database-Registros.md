...
- Consumo diário consolidado pelas funções `dashboard_hoje` (soma do dia + limite) e `dashboard_ultimos_dias` (soma por dia) — ver [rpc.md](Specs-Current-Database-Rpc).
...
- `dashboard_hoje` (SELECT, soma do dia) — [rpc.md](Specs-Current-Database-Rpc)
- `dashboard_ultimos_dias` (SELECT, soma por dia) — [rpc.md](Specs-Current-Database-Rpc)
- `remover_ou_desativar_referencia` (SELECT para verificar vínculo de referência) — [rpc.md](Specs-Current-Database-Rpc)
...
- [referencias.md](Specs-Current-Database-Referencias), [rpc.md](Specs-Current-Database-Rpc), [usuarios.md](Specs-Current-Database-Usuarios)
