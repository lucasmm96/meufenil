...
- [FEAT-0017 — Sincronização controlada de referências](Specs-Archive-Archive-Implemented-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa) — revisão direta: curadoria e rollback removidos; deleção física adicionada; BR-040/043/046 impactadas
- [FEAT-0012 — Painel administrativo](Specs-Archive-Implemented-Current-Features-FEAT-0012-Painel-Administrativo) — remoção de seções de curadoria; simplificação da seção de syncs
...
- [ADR-0010 — RPCs SECURITY DEFINER](Specs-Archive-Decisions-ADR-0010-Rpcs-Security-Definer) — atualização de `aplicar_sync_referencias`; remoção de `decidir_pendencia_referencia` e `reverter_sync_referencias`
...
- [FEAT-0017](Specs-Archive-Archive-Implemented-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa) — revisão direta da spec implementada (contexto e BRs impactadas)
...
- [FEAT-0017 — spec arquivada](Specs-Archive-Archive-Implemented-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa)
- [../current/backend/api-referencias-sync.md](Specs-Archive-Implemented-Current-Backend-Api-Referencias-Sync)
- [../current/database/referencias.md](Specs-Archive-Implemented-Current-Database-Referencias)
- [../current/domain/business-rules.md](Specs-Archive-Implemented-Current-Domain-Business-Rules) — BR-037, BR-040, BR-043, BR-046
