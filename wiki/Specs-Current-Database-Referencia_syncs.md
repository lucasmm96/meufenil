...
- RPC `aplicar_sync_referencias` — [rpc.md](Specs-Current-Database-Rpc)
- RPC `decidir_pendencia_referencia` — [rpc.md](Specs-Current-Database-Rpc)
- RPC `reverter_sync_referencias` — [rpc.md](Specs-Current-Database-Rpc)
- Rota `api/referencias-sync.ts` — [../backend/api-referencias-sync.md](Specs-Current-Backend-Api-Referencias-Sync)
...
- [referencia_sync_pendencias.md](Specs-Current-Database-Referencia_sync_pendencias), [referencia_eventos.md](Specs-Current-Database-Referencia_eventos), [referencia_snapshots.md](Specs-Current-Database-Referencia_snapshots), [referencia_backups.md](Specs-Current-Database-Referencia_backups)
- [rpc.md](Specs-Current-Database-Rpc), [../security/security-model.md](Specs-Current-Security-Security-Model) (§11)
