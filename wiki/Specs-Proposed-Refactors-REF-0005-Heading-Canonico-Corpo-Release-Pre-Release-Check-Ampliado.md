...
- [REF-0004 — automação de limpeza do gate + padrão preventivo para release](Specs-Archive-Implemented-Refactors-REF-0004-Automacao-Residuo-Gate-E-Prevencao-Tentativa-Erro) — criou o `pre-release-check.js` (corpo do PR).
- [CONVENTIONS.md §18.9](Specs-CONVENTIONS) — exemplo canônico da tabela.
- [ADR-0013 — fluxos automáticos determinísticos sem IA](Specs-Decisions-ADR-0013-Fluxos-Automaticos-Deterministicos-Sem-Ia) — W6/W7 determinísticos.
...
- [ADR-0013 — fluxos automáticos determinísticos sem IA](Specs-Decisions-ADR-0013-Fluxos-Automaticos-Deterministicos-Sem-Ia) — W7 `release-gate` e W6 `release-verify`: a proposta estende o padrão preventivo local (REF-0004) do corpo do PR para o corpo da Release.
...
- [CONVENTIONS.md §18.9](Specs-CONVENTIONS).
- [REF-0004 — arquivada como IMPLEMENTED](Specs-Archive-Implemented-Refactors-REF-0004-Automacao-Residuo-Gate-E-Prevencao-Tentativa-Erro).
- [ADR-0013 — fluxos automáticos determinísticos sem IA](Specs-Decisions-ADR-0013-Fluxos-Automaticos-Deterministicos-Sem-Ia).
