...
- RPCs `aplicar_sync_referencias`, `restaurar_referencias_de_backup` — [rpc.md](Specs-Current-Database-Rpc)
...
- [referencia_syncs.md](Specs-Current-Database-Referencia_syncs) (~~[referencia_sync_pendencias.md](Specs-Current-Database-Referencia_sync_pendencias)~~ — tabela dropped pelo ENH-0009)
