...
- Trigger `trg_auditar_is_ativa_manual` — função `fn_auditar_is_ativa_manual` — [triggers.md](Specs-Current-Database-Triggers)
- RPCs `aplicar_sync_referencias`, `decidir_pendencia_referencia`, `reverter_sync_referencias`, `restaurar_referencias_de_backup` — [rpc.md](Specs-Current-Database-Rpc)
...
- [referencia_syncs.md](Specs-Current-Database-Referencia_syncs), [referencia_sync_pendencias.md](Specs-Current-Database-Referencia_sync_pendencias)
- [rpc.md](Specs-Current-Database-Rpc), [triggers.md](Specs-Current-Database-Triggers), [../security/security-model.md](Specs-Current-Security-Security-Model) (§11)
