...
O gate de validação cobre três etapas (ver [testing-strategy.md](Specs-Current-Testing-Testing-Strategy)):
...
- [testing-strategy.md](Specs-Current-Testing-Testing-Strategy) — gate W1 precisa ser estendido.
- [secrets-and-environments.md](Specs-Current-Security-Secrets-And-Environments) — ambiente de execução das rotas Vercel documentado ali.
...
- [api-referencias-sync.md](Specs-Current-Backend-Api-Referencias-Sync)
- [testing-strategy.md](Specs-Current-Testing-Testing-Strategy)
