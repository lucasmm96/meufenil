...
- [login-as.md](Specs-Current-Frontend-Components-Login-As) (banner), [../pages/home.md](Specs-Current-Frontend-Pages-Home) (única página sem Layout), [../overview.md](Specs-Current-Frontend-Overview) (padrões visuais)
