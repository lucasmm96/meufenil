...
- Trigger `trg_trim_background_job_executions` (AFTER INSERT) — função `fn_trim_background_job_executions` — [triggers.md](Specs-Current-Database-Triggers)
...
- [triggers.md](Specs-Current-Database-Triggers), [rpc.md](Specs-Current-Database-Rpc) (`is_admin_user`, `fn_trim_background_job_executions`)
