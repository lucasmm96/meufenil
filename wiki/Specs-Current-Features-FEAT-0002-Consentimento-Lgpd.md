...
- [BR-028](Specs-Current-Domain-Business-Rules)

## Frontend

- [components/consentimento-lgpd](Specs-Current-Frontend-Components-Consentimento-Lgpd), [pages/dashboard](Specs-Current-Frontend-Pages-Dashboard)
...
- [usuarios](Specs-Current-Database-Usuarios) (`consentimento_lgpd_em`)

## Security

- [security-model](Specs-Current-Security-Security-Model) (contexto de dados pessoais; sem enforcement adicional de segurança)
...
- [FEAT-0010 Perfil](Specs-Current-Features-FEAT-0010-Perfil-Usuario) (direitos: exportar/excluir)
