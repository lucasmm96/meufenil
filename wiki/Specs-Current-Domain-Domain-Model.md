...
- **Atributos relevantes:** nome (sem sufixo de marca desde a ENH-0004), `marca` (default `''` desde 2026-09-04 — em branco = marca não declarada; `'Produto In Natura'` apenas como marca declarada pela fonte ANVISA), `fenil_mg_por_100g` (`numeric(10,2)` desde 2026-09-11 — até 2 casas decimais; era `numeric(10,1)` desde a ENH-0004), `criado_por`, `is_global`, `is_ativa` `[CONFIRMED: database]`.
...
- [business-rules.md](Specs-Current-Domain-Business-Rules), [../product/glossary.md](Specs-Current-Product-Glossary), [../database/](Specs-Current-Database)
