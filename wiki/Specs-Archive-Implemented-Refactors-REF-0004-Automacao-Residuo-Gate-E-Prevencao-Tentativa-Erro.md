...
- [ADR-0013 — fluxos automáticos determinísticos sem IA](Specs-Archive-Decisions-ADR-0013-Fluxos-Automaticos-Deterministicos-Sem-Ia) — gate determinístico W7.
...
- [ADR-0013 — fluxos automáticos determinísticos sem IA](Specs-Archive-Decisions-ADR-0013-Fluxos-Automaticos-Deterministicos-Sem-Ia) — W7 `release-gate`: a proposta estende o comportamento do gate (limpeza do comentário de falha no sucesso) e adiciona checagem preventiva local ao fluxo de release.
...
- PR #48 (release v1.10.0 — contexto da descoberta).
- [ADR-0013 — fluxos automáticos determinísticos sem IA](Specs-Archive-Decisions-ADR-0013-Fluxos-Automaticos-Deterministicos-Sem-Ia).
