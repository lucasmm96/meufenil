...
**Tipo:** Current
**Status:** Implementada
**Última verificação:** 2026-09-07 (FEAT-0017 M6 — UI do Admin estendida com seções de sincronização de referências/curadoria/recuperação; página [admin](Specs-Current-Frontend-Pages-Admin))
...
- [BR-009](Specs-Current-Domain-Business-Rules), [BR-016](Specs-Current-Domain-Business-Rules)

## Frontend

- [pages/admin](Specs-Current-Frontend-Pages-Admin)
...
- RPC [get_estatisticas_admin](Specs-Current-Database-Rpc) (via PostgREST)

## Database

- [usuarios](Specs-Current-Database-Usuarios), [background_job_executions](Specs-Current-Database-Background_job_executions)

## Security

- [security-model](Specs-Current-Security-Security-Model) (Admin Matrix — sem acesso RLS a registros/exames/favoritas/delegações)
...
- [FEAT-0013 Background jobs](Specs-Current-Features-FEAT-0013-Background-Jobs), [FEAT-0008 Referências](Specs-Current-Features-FEAT-0008-Referencias-Alimentares), [FEAT-0017 Sincronização de referências](Specs-Current-Features-FEAT-0017-Sincronizacao-Referencias-Anvisa) (seções de sincronização/curadoria/recuperação no Admin — M6)
