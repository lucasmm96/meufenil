...
- [../current/security/security-model.md](Specs-Current-Security-Security-Model) (seção 9), [../current/features/FEAT-0011-delegacao-acesso.md](Specs-Current-Features-FEAT-0011-Delegacao-Acesso), [../current/database/delegacoes_acesso.md](Specs-Current-Database-Delegacoes_acesso), [../current/backend/edge-function-delegar-acesso.md](Specs-Current-Backend-Edge-Function-Delegar-Acesso)
