...
- [../current/backend/api-keepalive.md](Specs-Current-Backend-Api-Keepalive), [../current/backend/background-jobs.md](Specs-Current-Backend-Background-Jobs), [../current/database/background_job_executions.md](Specs-Current-Database-Background_job_executions), [../current/features/FEAT-0013-background-jobs.md](Specs-Current-Features-FEAT-0013-Background-Jobs)
- [DEBT-0006 — Restaurar keepalive do ambiente dev (regressão 879a6c0)](https://github.com/lucasmm96/meufenil/blob/master/.ai/archive/implemented/technical-debt/DEBT-0006-restaurar-keepalive-dev.md)
