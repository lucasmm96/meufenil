...
- O wiki-documenter ([FEAT-0016](Specs-Archive-Archive-Implemented-Features-FEAT-0016-Geracao-Automatica-De-Documentacao-Via-Agente-Wiki-Documenter)) gera documentação pública *interpretativa* (8 páginas + 9 páginas de tooling via ENH-0005) a partir das specs — não espelha as specs originais.
...
- `sync-wiki.yml` sincroniza `wiki/*.md` → GitHub wiki automaticamente a cada push em `master` ([`.github/workflows/sync-wiki.yml`](https://github.com/lucasmm96/meufenil/blob/master/.ai/.github/workflows/sync-wiki.yml)).
...
- [FEAT-0016](Specs-Archive-Archive-Implemented-Features-FEAT-0016-Geracao-Automatica-De-Documentacao-Via-Agente-Wiki-Documenter) — wiki-documenter (estendido, não alterado em comportamento existente).
...
- [FEAT-0016](Specs-Archive-Archive-Implemented-Features-FEAT-0016-Geracao-Automatica-De-Documentacao-Via-Agente-Wiki-Documenter) — wiki-documenter
- [ENH-0005](Specs-Archive-Archive-Implemented-Enhancements-ENH-0005-Revisao-Tooling-Ia) — revisão do tooling de IA (precedente de extensão)
- [`.github/workflows/sync-wiki.yml`](https://github.com/lucasmm96/meufenil/blob/master/.ai/.github/workflows/sync-wiki.yml) — workflow de sincronização
- [`.ai/specs/CONVENTIONS.md`](Specs-Archive-CONVENTIONS) — governança do Specification System
