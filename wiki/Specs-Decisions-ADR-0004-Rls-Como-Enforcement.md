...
- [../current/security/security-model.md](Specs-Current-Security-Security-Model) (matrizes)
...
- [../current/security/security-model.md](Specs-Current-Security-Security-Model), [../current/database/overview.md](Specs-Current-Database-Overview)
- [ADR-0010](Specs-Decisions-ADR-0010-Rpcs-Security-Definer)
