...
4. **Gráfico "Consumo por Dia":** Recharts `BarChart` com gradiente `#6366f1→#9333ea`, `radius=[8,8,0,0]`, ticks dd/MM e tooltip padrão do [overview.md](Specs-Current-Frontend-Overview); altura `h-64 sm:h-80` `[CONFIRMED: code — Estatisticas.tsx:178-218]`.
...
- [perfil.md](Specs-Current-Frontend-Pages-Perfil) (exportação JSON do perfil), [../database/registros.md](Specs-Current-Database-Registros)
