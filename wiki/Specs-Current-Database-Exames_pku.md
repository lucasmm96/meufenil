...
- Exames são por usuário; delegação permite que o delegado gerencie os exames do concedente (ver [delegacoes_acesso.md](Specs-Current-Database-Delegacoes_acesso)).
...
- [usuarios.md](Specs-Current-Database-Usuarios), [delegacoes_acesso.md](Specs-Current-Database-Delegacoes_acesso)
