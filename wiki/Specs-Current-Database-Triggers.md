...
- [rpc.md](Specs-Current-Database-Rpc) (funções das triggers), [referencias.md](Specs-Current-Database-Referencias), [background_job_executions.md](Specs-Current-Database-Background_job_executions), [usuarios.md](Specs-Current-Database-Usuarios)
