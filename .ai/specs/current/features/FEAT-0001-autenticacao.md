...
3. Trigger `on_auth_user_created` cria o perfil em `usuarios` (nome = full_name ou email, role user, timezone America/Sao_Paulo, limite 150) `[CONFIRMED: migration — baseline]`.
...
- [BR-025](../domain/business-rules.md) (perfil criado no sign-up com limite 150)
...
- E2 — Trigger e perfil: baseline `20260103015052_remote_schema.sql:120-148,680` `[CONFIRMED: migration]`
