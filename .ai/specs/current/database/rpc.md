...
**Última verificação:** 2026-09-25 (ENH-0009 — migration 20260923000000 reescreveu a função; corretivas 20260924000000 (bugs A–D: coluna detalhes, tabela registros, unique_violation handler, auth.role() guard) e 20260924010000 (bugs E–F: sweep reprocess, mensagem unique_violation) — definição final em 20260924010000)
**Definição em:** `20260906000000_referencias_sync_aplicacao_curadoria.sql` (FEAT-0017 M4, original); **reescrita** por `20260923000000_enh_0009_delecao_fisica_sync_simplificacao.sql` (ENH-0009); **corrigida** por `20260924000000_enh_0009_correcao_aplicar_sync.sql` (bugs A–D) e `20260924010000_enh_0009_correcao2_sweep_mensagem.sql` (bugs E–F) `[CONFIRMED: migration]`
