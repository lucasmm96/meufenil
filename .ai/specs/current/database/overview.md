...
**Última verificação:** 2026-09-11 (FEAT-0017 M1–M6 — migrations 20260905*/20260906*/20260907000000 aplicadas em dev; prod segue no schema pré-ENH-0004 até a release. Nova migration 20260911000000 (`numeric(10,1)` → `numeric(10,2)`) versionada em branch de trabalho, **ainda NÃO aplicada em dev** — ver seção Migrations)
