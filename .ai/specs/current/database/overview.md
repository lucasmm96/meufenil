...
Este diretório documenta o estado REAL do banco de dados PostgreSQL (Supabase) do MeuFenil — tabelas, funções, triggers e políticas RLS — conforme observado nos bancos development e production, complementado pelas migrations versionadas e pelo código que interage com o banco. Desde 2026-09-04, dev e prod DIVERGEM: dev recebeu a ENH-0004 (coluna `marca`, identidade imutável de referências, ordem física das colunas — 2026-09-04) e o FEAT-0017 M1–M5 (tabelas de sincronização, auditoria de `is_ativa`, RPCs de aplicação/curadoria e de recuperação — 2026-09-06); prod segue no schema pré-ENH-0004 até a release (migrations novas em branch de trabalho; promoção segue gate de release) `[INFERRED: migrations não aplicadas em prod; release ainda não criada]`. As seções abaixo descrevem o estado dev pós-FEAT-0017 M1–M5 quando não indicado.
...
- E1 — Inventário de tabelas, colunas (52), constraints (19), índices (15 em 2026-08-14; dev pós-ENH-0004 = 14), flags RLS, políticas (31), funções (10 em 2026-08-14; dev pós-ENH-0004 = 8), enums (1 em `public`) e triggers (3 em `public` + 1 em `auth.users` em 2026-08-14; dev pós-ENH-0004 = 1 + 1): catálogo dos bancos dev e prod via queries somente-leitura (2026-08-14) + dev após migrations ENH-0004 (2026-09-04) + dev pós-FEAT-0017 M1/M4 (2026-09-06 — 12 tabelas, 100 colunas, 36 constraints, 36 índices, 36 políticas, 12 funções, 5 enums, 3 triggers em `public` + 1 em `auth.users`) + dev pós-FEAT-0017 M5 (2026-09-06 — 101 colunas, 15 funções; demais contagens inalteradas — migration 20260906010000) `[CONFIRMED: database, migration]`.
- E2 — Conteúdo das migrations em `supabase/migrations/` (baseline, 20260807, 20260810, 20260811, 20260814, 20260815, 20260904000000→040000, FEAT-0017: 20260905000000/010000/020000, 20260906000000 e 20260906010000) `[CONFIRMED: migration]`.
