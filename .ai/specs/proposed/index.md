...
|---|---|---|---|---|---|
| [ENH-0011](enhancements/ENH-0011-motivo-remocao-audit-json.md) | ENH | Motivo de remoção no evento e no audit JSON | ACCEPTED | #95 | gap identificado na revisão D-4 (sessão meuFenil018, 2026-09-25): `v_motivo` guia a RPC mas não é persistido |
...
| [DEBT-0008](technical-debt/DEBT-0008-labels-spec-por-categoria.md) | DEBT | Labels de spec por categoria em vez de labels por ID | PROPOSED | #94 | Label bloat: labels `spec:<ID>` 1:1, sem reuso — sessão meuFenil018 (2026-09-25) |
