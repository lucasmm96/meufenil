...
→ Estado atual em [`current/`](.ai/specs/current/) e agentes em [`.claude/agents/`](.claude/agents/).
...
- Convenções do tooling: [`CLAUDE.md`](CLAUDE.md) e [`.ai/specs/CONVENTIONS.md`](.ai/specs/CONVENTIONS.md)
- Agentes existentes: [`.claude/agents/`](.claude/agents/)
- [ADR-0012](.ai/specs/decisions/) — lifecycle de fases (ADR-0012)
- [ADR-0013](.ai/specs/decisions/) — fluxos determinísticos (ADR-0013)
